...

{
    ...
    grille->addWidget(ui->label,TAILLE,0,1,4);
    //port
    grille->addWidget(ui->spinBoxPort,TAILLE,5,1,3);
    // connexion et quitter
    grille->addWidget(ui->pushButtonLancer,TAILLE,10,1,4);
...
void ServeurCrawler::afficherGrille()
{
    ...
    foreach(QPoint pt, listePositions)
    {
        ...
        QBrush fondPixMap;
        QPixmap monpixmap("/home/USERS/ELEVES/SNIR2022/tsoulaimana/Qt/Snir 3 C++/Projet Noel/Projet_Noel2022/Perso.png");
        vue = new QGraphicsView(this);
    ...
    QGraphicsPixmapItem *rectTresor = new QGraphicsPixmapItem(QPixmap("/home/USERS/ELEVES/SNIR2022/tsoulaimana/Qt/Snir 3 C++/Projet Noel/Projet_Noel2022/serveur/tresors.png"));
